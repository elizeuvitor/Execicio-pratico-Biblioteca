...
using WebAppExercicio.Models;

namespace WebAppExercicio.Controllers
{
    public class RequisicaoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RequisicaoId,LivroId,DataRequisicao,DataEntrega,Alunoid")] Requisicao requisicao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RequisicaoId,LivroId,DataRequisicao,DataEntrega,Alunoid")] Requisicao requisicao)
        {
            if (ModelState.IsValid)
            {
